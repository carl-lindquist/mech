...
//    static uint16_t lastLightEvent = LIGHT_LIGHT;
//    
//    ES_EventTyp_t curEvent;
//    ES_Event thisEvent;
//    uint8_t returnVal = FALSE;
//    uint16_t lightLevel = Roach_LightLevel(); // read the battery voltage
//
//    if (lightLevel > LIGHT_THRESH) { // is battery connected?
//        curEvent = LIGHT_DARK;
//    } else {
//        curEvent = LIGHT_LIGHT;
//    }
//    if (curEvent != lastLightEvent) { // check for change from last time
//        thisEvent.EventType = curEvent;
//        thisEvent.EventParam = lightLevel;
//        returnVal = TRUE;
//        lastLightEvent = curEvent; // update history
...
//
//    ES_EventTyp_t curBumpEvent;
//    ES_Event anEvent;
//    uint8_t returnVal = FALSE;
//    uint8_t dataBump = Roach_ReadBumpers(); // read all bumpers
//    uint8_t releaseBumpStates =(lastDataBump&(dataBump^lastDataBump));
//    uint8_t pressBumpStates =(dataBump&(dataBump^lastDataBump));
//    
//    lastDataBump=dataBump;
//    if(releaseBumpStates || pressBumpStates){
//        if(releaseBumpStates){
//            curBumpEvent=BUMPER_RELEASED;
//        }else{
//            curBumpEvent=BUMPER_PRESSED;
//        }
//        uint8_t currentBump=pressBumpStates;
//        currentBump=currentBump|(releaseBumpStates<<4);
//        anEvent.EventType = curBumpEvent;
//        anEvent.EventParam = currentBump;
//        returnVal = TRUE;
//        
//                // update history
//        #ifndef EVENTCHECKER_TEST           // keep this as is for test harness
//            PostGenericService(anEvent);
//        #else
//            SaveEvent(anEvent);
//        #endif   
//    }
