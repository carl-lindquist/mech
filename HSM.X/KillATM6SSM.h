...
#ifndef KILL_ATM6_SSM_H  // <- This should be changed to your own guard on both
#define KILL_ATM6_SSM_H  //    of these lines
...
/**
 * @Function RunKillATM6SSM(ES_Event ThisEvent)
