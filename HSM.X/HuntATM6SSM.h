...
#ifndef HUNT_ATM6_SSM_H  // <- This should be changed to your own guard on both
#define HUNT_ATM6_SSM_H  //    of these lines
...
/**
 * @Function RunHuntATM6SSM(ES_Event ThisEvent)
